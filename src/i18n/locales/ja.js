export default {
  common: {
    ...
    description: '説明',
    photo: '写真',
    imageKeptHint: '現在の画像は上に表示されています — 変更する場合のみ新しいファイルを選択してください。',
    clearSearch: '検索をクリア',
    saving: '保存中…',
    loading: '読み込み中…',
    deactivate: '無効化',
  ...
  notifications: {
    ...
    orderShippedTitle: '商品を発送しました',
    orderShippedMessage: 'ご注文の商品が発送されました — タップして詳細を確認してください。',
  ...
  orderDetails: {
    ...
    shippingStatus: '配送状況',
    shippingPending: '未発送',
    shippingProcessing: '準備中',
    shippingCancelled: 'キャンセル済み',
    shippedOn: '{date}に発送済み',
    deliveredOn: '{date}に配達完了',
    items: '商品',
  ...
  managerEvents: {
    ...
    searchPlaceholder: 'イベント名・会場で検索…',
    noSearchResults: '該当するイベントが見つかりません。',
    cancelEvent: 'イベントを中止',
  ...
  managerProducts: {
    ...
    searchPlaceholder: '商品名・カテゴリーで検索…',
  ...
  managerOrders: {
    ...
    shippingCancelled: 'キャンセル済み',
    shipAction: '発送する',
    confirmShip: 'この注文を発送済みにしますか？購入者に通知が届き、この操作は取り消せません。',
    shipSuccess: '注文を発送済みにしました。'
  },
