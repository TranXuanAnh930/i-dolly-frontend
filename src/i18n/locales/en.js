export default {
  common: {
    ...
    photo: 'Photo',
    imageKeptHint: 'Current image shown above — choose a new file only to replace it.',
  ...
  notifications: {
    ...
    orderShippedMessage: 'Your order is on its way — tap to view it.',
  ...
  lotteryDetails: {
    ...
    wonPaidNote: 'You\'ve won a ticket entry for {title} — already paid and confirmed.',
    event: 'Event',
    tier: 'Tier',
    quantity: 'Quantity',
    drawnAt: 'Drawn',
  ...
  lotteryPayment: {
    ...
    declinedTitle: 'Payment declined',
    declinedNote: 'The mock gateway declined this charge. This lottery win has been cancelled — the ticket is no longer available.',
  ...
  managerEvents: {
    ...
    noSearchResults: 'No events match that search.',
  ...
  managerEventForm: {
    ...
    entriesOfCapacity: '{entries} / {capacity} entries',
    campaignAlreadyOpenHint: 'This tier already has an open campaign — close or let it end before adding another.',
  ...
  managerProducts: {
    ...
    noSearchResults: 'No products match that search.',
    viewSales: 'Sales'
  },
  ...
  managerOrders: {
    ...
    shippingCancelled: 'Cancelled',
    shipAction: 'Ship',
    confirmShip: 'Mark this order as shipped? The buyer will be notified, and this can\'t be undone.',
