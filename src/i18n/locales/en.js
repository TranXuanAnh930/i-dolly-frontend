export default {
  ...
  lotteryEntry: {
    ...
    firstChoiceLockedNote: 'Your pick',
    lockedExistingNote: 'Already entered',
    clearRank: 'Clear this rank',
    selectTierPlaceholder: 'Select a tier…',
    reviewEntry: 'Review entry',
    reviewUpdate: 'Review changes',
    ...
    confirmNote: 'Winners are drawn on {date} and notified here and by email.',
