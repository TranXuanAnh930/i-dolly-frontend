<!--
  A simplified, illustrative arena diagram (stage + three fanning seat zones) —
  not tied to a real venue's actual layout, same as the "image only" seat
  charts real ticket sites publish before seats go on sale.
-->
<template>
